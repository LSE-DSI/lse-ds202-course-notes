...
- We will have a couple of drop-in sessions at the start of next week. Check the <code>#general</code> channel on Slack. Bring questions! 
...
- You will be asked to write your solutions using R Markdown. You will find the template on Moodle.
- You will not need to submit your R Markdown file, but you will need to submit the HTML file.
- You will be able to submit your solutions until 1 pm unless you have been granted extra time due to learning adjustments.
...
- **⚠️ We advise you to finish the exam by noon and leave the extra hour just for knitting the file and submitting it via Moodle.** Late submissions will be penalised.