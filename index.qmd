...
If you are having problems installing the `topicmodels` package while solving the [✍️ Summative Problem Set (03) | W11-W11+1](/assessments/summative3.qmd), we will accept the use of clustering methods instead (k-means, for example). 
:::
