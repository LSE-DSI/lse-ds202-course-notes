...
Run k-means on the same data, but this time vary k from $\{1, 2, \ldots, 19, 20\}$ and generate an elbow plot. According to the plot, what is a "good" number of clusters, k.
