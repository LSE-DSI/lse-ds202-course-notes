---
title: "💻 Week 09 - Lab Roadmap (90 min) w/ solutions"
...
The clusters are still not very similar to the `species` of penguins. This shows that clustering is not a great tool for distinguishing between the `species` of penguins.
