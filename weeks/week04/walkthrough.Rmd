...
```{r}
train_samples <- readRDS("./weeks/week04/Dataset 01/samples_train.rds")
test_samples  <- readRDS("./weeks/week04/Dataset 01/samples_test.rds") 
```
...
ggplot(df_results, aes(x=pred_test_prob, fill=target)) +
  geom_histogram(binwidth=0.05) +
