...
Include something like /figures/week03/Plot4.pdf -->
...
and call this method the <mark>Maximum Likelihood Estimate</mark> (MLE).
<!-- :::
...
<!-- ::: incremental -->
- MLE is much more difficult to solve than the least squares formulations used in Linear Regression.
