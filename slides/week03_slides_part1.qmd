...
- In the absence of `balance` information:
  ...
  - $p(\text{default}=\text{Yes}) = \frac{\text{odds}}{(1 + \text{odds})} = 2.366877 \times 10^{5}$
...
- With `balance` information:
  ...
  - $p(\text{default}=\text{Yes}|\text{balance}) = \frac{\text{odds}}{(1 + \text{odds})} = 0.5013747$
