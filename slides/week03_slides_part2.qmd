...
::: {.fragment}
- Assuming features are not associated (correlated), the likelihood becomes:
  $$ 
  P(\mathbf{X}|\mathbf{Y}=k) = P(x_1 |\mathbf{Y}=k) \times P(x_2 |\mathbf{Y}=k) \times \ldots \times P(x_p |\mathbf{Y}=k)
  $$
:::
