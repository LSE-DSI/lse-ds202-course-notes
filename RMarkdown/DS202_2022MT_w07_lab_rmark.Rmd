...
1.  Remove any observations with missing data. :bulb:You can pipe `na.omit()` into you sequence of commands to achieve this.
...
Check the solution [on the webpage of this lab roadmap](https://lse-dsi.github.io/lse-ds202-course-notes/weeks/week07/lab.html).
...
> If you need to recap on non-linear algorithms, rewatch [:man_teacher: Week 05 - Lecture](/weeks/week05/lecture.html) or check the slides online.
...
*Don't understand what the code above does? You might want to read [Chapter 3 of R for Data Science](https://r4ds.had.co.nz/data-visualisation.html) to review `ggplot`.*
...
:handshake: **WORKING TOGETHER** In pairs, discuss the following:
...
:soon: Next week, we will continue our journey of supervised learning by exploring the Support Vector Machine algorithm. We will also visit once again the topic of resampling (cross-validation) to select the optimal parameters for classifiers and regressors.
